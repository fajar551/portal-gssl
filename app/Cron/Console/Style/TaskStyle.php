...
namespace App\Cron\Console\Style;
...
class TaskStyle extends \Symfony\Component\Console\Style\SymfonyStyle
{
    ...
    public function describeTask(\App\Scheduling\Task\TaskInterface $task)
    {
        if ($this->isDebug() && $task->getAccessLevel() == \App\Scheduling\Task\TaskInterface::ACCESS_USER) {
