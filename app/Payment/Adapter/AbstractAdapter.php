...
abstract class AbstractAdapter implements AdapterInterface
{
    ...
    {
        if (!\App\Payment\Solutions::isValidSolutionType($type)) {
    ...
    {
        throw new \App\Payment\Exception\MethodNotImplemented(sprintf("Method %s has been called, but is not defined in class %s", "captureTransaction", get_class($this)));
    }
    public function refundTransaction(array $params)
    {
        throw new \App\Payment\Exception\MethodNotImplemented(sprintf("Method %s has been called, but is not defined in class %s", "refundTransaction", get_class($this)));
    }
    public function storePaymentDetailsRemotely(array $params)
    {
        throw new \App\Payment\Exception\MethodNotImplemented(sprintf("Method %s has been called, but is not defined in class %s", "storePaymentDetailsRemotely", get_class($this)));
    }
}
