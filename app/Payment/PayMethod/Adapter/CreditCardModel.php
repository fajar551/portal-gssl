...
abstract class CreditCardModel extends BaseAdapterModel implements \App\Payment\Contracts\CreditCardDetailsInterface
{
    ...
    {
        return $this->expiry_date->lt(\App\Helpers\Carbon::now());
    }
}
