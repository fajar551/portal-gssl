...
trait CreditCardDetailsTrait
{
    ...
    public function setCardNumber($value)
    {
        ...
        if ($value) {
            $this->setCardType(\App\Helpers\Cc::getCardTypeByCardNumber($value));
    ...
    public function getExpiryDate()
    {
        ...
        if ($date && $date != "0000-00-00 00:00:00") {
            return (new \App\Helpers\Carbon($date))->startOfDay();
        }
        return null;
    }
    ...
    public function getStartDate()
    {
        ...
        if ($date) {
            return \App\Helpers\Carbon::fromCreditCard($date);
        }
        return null;
    }
