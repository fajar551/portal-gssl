...
class Collection extends \Illuminate\Database\Eloquent\Collection
{
    public function forGateway($gatewayModule)
    {
        ...
        return $this->filter(function (\App\Payment\Contracts\PayMethodInterface $adapter) use($gatewayModule, $isCcGateway) {
    ...
    {
        return $this->filter(function (\App\Payment\Contracts\PayMethodInterface $adapter) {
    ...
    {
        return $this->filter(function (\App\Payment\Contracts\PayMethodInterface $adapter) {
            return $adapter->getType() === \App\Payment\Contracts\PayMethodTypeInterface::TYPE_CREDITCARD_LOCAL;
        });
    }
    public function bankAccounts()
    {
        return $this->filter(function (\App\Payment\Contracts\PayMethodInterface $adapter) {
            return $adapter->getType() === \App\Payment\Contracts\PayMethodTypeInterface::TYPE_BANK_ACCOUNT;
        });
    }
