...
namespace App\Helpers\Domain\Registrar;
...
class Domain
{
    ...
    public function setExpiryDate(\App\Helpers\Carbon $expiryDate = NULL)
    {
    ...
    public function setTransferLockExpiryDate(\App\Helpers\Carbon $transferLockExpiryDate = NULL)
    {
    ...
    public function setIrtpTransferLockExpiryDate(\App\Helpers\Carbon $irtpTransferLockExpiryDate)
    {
    ...
    public function setDomainContactChangeExpiryDate(\App\Helpers\Carbon $domainContactChangeExpiryDate = NULL)
    {
