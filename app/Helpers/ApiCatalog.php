...
class ApiCatalog
{
    ...
    {
        $storedApiCatalog = \App\Helpers\Cfg::getValue(static::SETTING_API_CATALOG);
    ...
    public static function factoryApiRole(ApiCatalog $catalog, $permissionClass = "WHMCS\\Api\\Authorization\\ApiRole")
    {
    ...
    public static function store(Catalog $catalog = NULL)
    {
        ...
        \App\Helpers\Cfg::setValue(static::SETTING_API_CATALOG, $data);
    }
	...
	{
		$permissions = \Spatie\Permission\Models\Permission::where('guard_name', 'api')->orderBy('name', 'ASC')->get();
