...
class Cron
{
    ...
    public function raiseLimits()
    {
        ...
        $memoryLimitConfiguredBytes = \App\Helpers\Php::convertMemoryLimitToBytes(ini_get("memory_limit"));
        $memoryLimitRequiredBytes = \App\Helpers\Php::convertMemoryLimitToBytes($minimumMemoryLimitSetting);
    ...
    public function emailReport()
    {
        if ($this->sendreport) {
            ...
            \App\Helpers\Functions::sendAdminNotification("system", "CBMS Cron Job Activity", $cronreport);
        } else {
    ...
    public static function getCronsPath($fileName)
    {
        ...
        // }
        // return $path;
		throw new \Exception("Unable to locate CBMS crons folder.");
    }
    ...
    {
        (new \App\Cron\Status())->setLastDailyCronInvocationTime($datetime);
    }
    public function getLastDailyCronInvocationTime()
    {
        return (new \App\Cron\Status())->getLastDailyCronInvocationTime();
    }
    public function hasDailyCronRunInLast24Hours()
    {
        return (new \App\Cron\Status())->hasDailyCronRunInLast24Hours();
    }
    public function hasDailyCronEverRun()
    {
        return (new \App\Cron\Status())->hasDailyCronEverRun();
    }
    public function hasCronEverBeenInvoked()
    {
        return (new \App\Cron\Status())->hasCronEverBeenInvoked();
    }
    public static function getDailyCronExecutionHour()
    {
        return \App\Cron\Status::getDailyCronExecutionHour();
    }
    public static function setDailyCronExecutionHour($time = "09")
    {
        \App\Cron\Status::setDailyCronExecutionHour($time);
    }
    public function isOkayToRunDailyCronNow()
    {
        return (new \App\Cron\Status())->isOkayToRunDailyCronNow();
    }
    public function hasCronBeenInvokedIn24Hours()
    {
        return (new \App\Cron\Status())->hasCronBeenInvokedIn24Hours();
    }
    public function getLastCronInvocationTime()
    {
        return (new \App\Cron\Status())->getLastCronInvocationTime();
    }
    public function setCronInvocationTime()
    {
        (new \App\Cron\Status())->setCronInvocationTime();
    }
}
