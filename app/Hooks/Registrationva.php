...
use App\Events\AdminAreaRegister; 
...
class Registrationva
{
    public function handle(AdminAreaRegister $event) 
    {
        ...
        if (!$vaExists) {
            ...
            $merFixAcctId = str_pad($userId, 8, "0", STR_PAD_LEFT); // Ubah padding menjadi 8 karakter dengan nol
