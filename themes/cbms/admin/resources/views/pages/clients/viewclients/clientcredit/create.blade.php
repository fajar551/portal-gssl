                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card p-3 min-vh-100 bg-white">
                                        <div class="row">
                                            <label class="col-sm-6 col-form-label">{{ ucfirst($type) }} Credit</label>
                                        </div>
                                        <form method="POST" action="{{ route("admin.pages.clients.viewclients.clientcredit.store") }}" enctype="multipart/form-data" class="needs-validation" novalidate autocomplete="off">
                                            @csrf
                                                ...
                                                <div class="row flex-wrap">
                                                    <div class="col-sm-12 col-lg-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" cols="75" rows="4" placeholder="Description" autocomplete="off" required>{{ old("description") }}</textarea>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number" min="0" step="0.01" name="amount" class="form-control @error('amount') is-invalid @enderror" id="amount" value="{{ old("amount") ?? "0.00" }}" placeholder="Amount" autocomplete="off">
                                                                @error('amount')
                                                                    <div class="text-danger" >{{ $message }}</div>
                                                                @enderror
                                                            </div>
