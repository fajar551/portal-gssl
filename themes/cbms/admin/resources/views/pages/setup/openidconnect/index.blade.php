...
@section('title')
    <title>{{ Cfg::getValue('CompanyName') }} -  OpenID Connect</title>
@endsection
                        ...
                        <div class="view-client-wrapper">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <!-- START HERE -->
                                    <div class="card p-3">
                                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae minus earum
                                            iusto dicta architecto aspernatur?</p>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <a href="{{ url('admin/setup/openidconnect/add') }}">
                                                    <button class="btn btn-outline-success px-2"><i class="fa fa-plus mr-2"
                                                            aria-hidden="true"></i> Generate New Client API
