...
@section('title')
    <title>{{ Cfg::getValue('CompanyName') }} -  Edit Promotions</title>
@endsection
                    ...
                    <div class="col-xl-12">
                        <div class="view-client-wrapper">
                            ...
                            <div class="row">
                                ...
                                @endif
                                    <!-- START HERE -->
                                    <form action="{{ url(Request::segment(1).'/setup/payments/promotions/update') }}" method="post" enctype="multipart/form-data">
                                    <div class="card p-3">
                                        <h4 class="card-title mb-3">Edit Promotion</h4>
                                        <div class="form-group row">
                                            <label class="col-sm-12 col-lg-2 col-form-label">Promotion Code</label>
                                            <div class="col-sm-12 col-lg-3">
                                                <input type="text" name="code" value="{{ $data->code }}" id="promocode" class="form-control">
                                            </div>
                                            <div class="col-sm-12 col-lg-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-lg-10">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h6 class="font-weight-bolder"><strong>Products/Services</strong></h6>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 mt-3">
                                                        <h6 class="font-weight-bolder"><strong>Domains</strong></h6>
                                                    </div>
                                                    <div class="col-lg-12 col-sm-6 d-lg-flex">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-lg-3">
                                                ...
                                                <div class="input-daterange input-group datepicker" id="inputRegDate">
                                                    <input type="text" class="form-control" name="startdate" placeholder="dd/mm/yyyy" value="{{ $data->startdate }}" autocomplete="off">
                                                </div>
                                                -->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12 col-lg-10 pt-2">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="upgradetype" value="product"  {{ ($upgradeconfig['discounttype'] == 'product')?'checked':'' }}>
                                                                <label class="form-check-label">Products/Services </label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="upgradetype" value="configoptions" {{ ($upgradeconfig['discounttype'] == 'configoptions' )?'checked':'' }}>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-3">
                                                                    <select name="upgradediscounttype" class="form-control">
                                                                        <option value="Percentage" {{ ($upgradeconfig['discounttype'] == 'Percentage')?'selected':'' }} >Percentage</option>
                                                                        <option value="Fixed Amount" {{ ($upgradeconfig['discounttype'] == 'Fixed Amount')?'selected':'' }}>Fixed Amount</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12 col-lg-5">
                                                            <select name="configoptionupgrades[]" class="form-control" multiple>
                                                                @foreach($config as $r)
                                                                    <option value="{{ $r->id }}" @if($upgradeconfig['configoptions'] !='') {{ in_array($r->id,$upgradeconfig['configoptions'])?'selected':'' }} @endif >{{ $r->name }} - {{ $r->optionname }} </option>
                                                                @endforeach
