...
@section('title')
   <title>{{ Cfg::getValue('CompanyName') }} -  Edit Admin</title>
@endsection
                  ...
                  <div class="view-client-wrapper">
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <!-- START HERE -->
                           <form
                              action="{{ route('admin.pages.setup.staffmanagement.administratorusers.update', $selectedAdmins->id) }}"
                              method="POST" id="AdminForm">
                              @csrf
                              <div class="card p-3">
                                 <h6>Edit Administrator</h6>
                                 <hr>
                                 <div class="row">
                                    <div class="col-lg-12">
                                          ...
                                          <div class="col-sm-12 col-lg-4">
                                             <select class="form-control" name="roleid">
                                                @foreach ($roleList as $key => $value)
                                                   <option value="{{ $key }}"
                                                      {{ $selectedAdmins->roleid == $key ? 'selected' : '' }}>
                                                      {{ $value }}</option>
                                                @endforeach
                                             </select>
                                          </div>
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-12 col-lg-5">
                                             <input type="text" class="form-control" name="firstname"
                                                placeholder="e.g: John" value="{{ $selectedAdmins->firstname }}">
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-12 col-lg-5">
                                             <input type="text" class="form-control" name="lastname"
                                                placeholder="e.g: Doe" value="{{ $selectedAdmins->lastname }}">
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-12 col-lg-6">
                                             <input type="email" class="form-control" name="email"
                                                placeholder="example@mail.co.id" value="{{ $selectedAdmins->email }}">
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-12 col-lg-3">
                                             ...
                                             <small>(Enter only if you want to change the password)</small>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                                   ...
                                                   <div class="col-lg-4">
                                                      <div class="custom-control custom-checkbox">
                                                         <input name="supportdepts[]" type="checkbox"
                                                            ...
                                                            id="customCheck{{ $id }}" value="{{ $id }}"
                                                            @foreach ($selectedDepts as $item)
                                                         {{ $item == $id ? 'checked' : '' }}
                                                @endforeach
                                                >
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-10">
                                       <textarea name="signature" id="signature" cols="30" rows="5"
                                          class="form-control">{{ $selectedAdmins->signature }}</textarea>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-10">
                                       <textarea name="notes" id="notes" cols="30" rows="4"
                                          class="form-control">{{ $selectedAdmins->notes }}</textarea>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                       <select name="template" id="template" class="form-control">
                                          <option value="0" {{ $selectedAdmins->template == 0 ? 'checked' : '' }}>
                                             Blend</option>
                                       </select>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                       <select name="language" id="language" class="form-control">
                                          <option value="0" {{ $selectedAdmins->language == 0 ? 'checked' : '' }}>
                                             English</option>
                                       </select>
                                    </div>
                                 </div>
                                    ...
                                    <div class="col-sm-12 col-lg-10 pt-2">
                                       <div class="custom-control custom-checkbox">
                                          ...
                                          <input type="checkbox" name="disabled" class="custom-control-input"
                                             ...
                                             {{ $selectedAdmins->disabled == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row">
                           <div class="col-lg-12 d-flex justify-content-center">
                              ...
                              <a href="{{ route('admin.pages.setup.staffmanagement.administratorusers.index') }}">
