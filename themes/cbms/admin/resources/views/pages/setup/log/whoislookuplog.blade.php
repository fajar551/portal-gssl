...
@section('title')
    <title>{{ Cfg::getValue('CompanyName') }} -  WHOIS Lookup Log</title>
@endsection
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="card-title mb-3">
                              <h4 class="mb-3">WHOIS Lookup Log</h4>
                        </div>
                     </div>
                  </div>
            ...
            if (! $.fn.dataTable.isDataTable('#transactionlist') ) {
               ...
               var ipaddress=$('#ipaddress').val(); */
                ...
                var tbl =$('#activitylog').DataTable({
                            ...
                            ajax:{
                                url : route('admin.whoislookuplog.ajax'),
                                type: 'POST',
                                headers : {
                            ...
                            columns : [
                              ...
                              { data: 'date', name: 'date', },
                              { data: 'domain ', name: 'domain', defaultContent:'' },
