                        ...
                        <div class="view-client-wrapper">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <!-- START HERE -->
                                    <div class="card p-3">
                                    <form action="{{ url(Request::segment(1).'/setup/productservices/configurableoptions/duplicategroup') }}" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12 mb-3">
                                                <h4 class="card-title">Duplicate Group</h4>
                                            </div>
                                            <div class="col-lg-12">
                                               
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-12 col-lg-2 col-form-label">Existing Group</label>
                                                    <div class="col-sm-12 col-lg-5">
                                                        <select name="existinggroupid" id="" class="form-control" >
                                                            @foreach($data as $r)
                                                ...
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-12 col-lg-2 col-form-label">New Group Name</label>
                                                    <div class="col-sm-12 col-lg-5">
