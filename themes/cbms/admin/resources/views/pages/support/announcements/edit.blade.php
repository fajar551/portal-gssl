...
@section('title')
    <title>{{ Cfg::getValue('CompanyName') }} -  Edit Announcements</title>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="view-client-wrapper">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="post" action="{{route('admin.pages.support.announcements.update', $announcment->id)}}" method="post">
                                        @csrf
                                        <div class="card p-3">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input value="{{old('date') ? old('date') : $announcment->date->format('Y-m-d H:i')}}" type="text" name="date" id="announcementSupport" class="form-control datetime" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="titleAnnouncement" class="col-sm-2 col-form-label">Title</label>
                                                    <div class="col-sm-5">
                                                        <input value="{{old('title') ? old('title') : $announcment->title}}" type="text" name="title" id="titleAnnouncement" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <textarea name="message" class="summernote" required>{{old('message') ? old('message') : $announcment->announcement}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-check mt-2">
                                                            <input name="published" class="form-check-input" type="checkbox" id="defaultCheck1" {{$announcment->published ? 'checked' : ''}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
