                                          ...
                                          <div class="row">
                                             <div class="col-sm-3 col-md-6 my-2">
                                                <div class="float-left">
                                                   <button type="button" id="bttattachfile" class="btn btn-info m-2">Attach Files</button>
                                                </div>
                                                <div class="float-left">
                                                               ...
                                                               <div class="mb-2">
                                                                  <a href="{{ $fileUrl }}" data-lightbox="image">
                                                                     ...
                                                                     <div class="ticketattachmentinfo text-center">
                                                                        ...
                                                                        <div class="small text-muted mt-1">{{ basename($fileUrl) }}</div>
                                                                     </div>
                                                                  </a>
                                                                  <div class="ticketattachmentlinks pt-2">
                                                                     <small>
                                                                        <a download="{{ basename($fileUrl) }}" href="{{ $fileUrl }}" class="download-link">download</a> |
