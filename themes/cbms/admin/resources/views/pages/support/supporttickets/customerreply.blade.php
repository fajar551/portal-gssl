                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group row">
                                                                        <label for="client-name" class="col-sm-2 col-form-label">Client
                                                                            Name</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="clientName" id="client" class="form-control select2-placeholder" style="width: 100%;">
                                                                                @if(!empty($user))
                                                                                <option value="{{ $user->id }}"> {{ $user->firstname }} {{ $user->lastname }} | {{ $user->email }} | {{ $user->companyname }} </option>
                                                                                @endif    
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="department-name" class="col-sm-2 col-form-label">Department</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="department_name[]" id="department-name" class="form-control select2-limiting" multiple="multiple">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="status-tickets" class="col-sm-2 col-form-label">Status</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="status_tickets[]" id="status-tickets" class="form-control select2-limiting" multiple="multiple">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="tags-name" class="col-sm-2 col-form-label">Tags</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="tags_name[]" id="tags-name" class="form-control select2-limiting" multiple="multiple">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="priority-level" class="col-sm-2 col-form-label">Priority</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="priority_level[]" id="priority-level" class="form-control select2-limiting" multiple="multiple">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="subject-message" class="col-sm-2 col-form-label">Subject/Message</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text" name="subject_message" id="subject-message" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="email-address" class="col-sm-2 col col-form-label">Email
                                                                            Address</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="email" name="email_address" id="email-address" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="ticket-id" class="col-sm-2 col-form-label">Ticket
                                                                            ID</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text" name="ticket_id" id="ticket-id" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="assigned-to" class="col-sm-2 col-form-label">Assigned
                                                                            To</label>
                                                                        <div class="col-sm-10">
                                                                            <select name="assigned_to" id="assigned-to" class="form-control select2-search-disable" style="width: 100%;">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-2 col-sm-6">
                                                    <select name="auto_refresh" id="auto-refresh" class="form-control" style="width: 100%;">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <button id="setINV" class="btn btn-success px-5">Set Auto Refresh</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
                ...
                processResults: function(data) {
                    return {
                        results: $.map(data, function(item) {
                            return {
                                text: item.firstname + ' ' + item.lastname + ' | ' + item.email + ' | ' + item.companyname,
                                id: item.id
                            }
                        })
                    };
        ...
        $('#department-name').select2({placeholder: 'Any',allowClear: true});
        $('#status-tickets').select2({placeholder: 'Any',allowClear: true});
        $('#priority-level').select2({placeholder: 'Any',allowClear: true});
        ...
        var data_tiket=function(filter=[]){
            if (! $.fn.dataTable.isDataTable('#tiket') ) {
                ...
                var tbl = $('#tiket').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ url('admin/support/supporttickets/customerreply') }}',
                        type: 'POST',
                        headers: {
