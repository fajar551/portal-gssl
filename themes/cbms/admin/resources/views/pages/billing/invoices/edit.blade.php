                                            ...
                                            <div class="card p-3">
                                                            ...
                                                            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="nav-add-payment-tab"
                                                                        data-toggle="tab" href="#nav-add-payment"
                                                                        role="tab" aria-controls="nav-add-payment"
                                                            ...
                                                            <div class="btn-group mb-2" role="group"
                                                                ...
                                                                <a target="_blank"
                                                                    ...
                                                                    class="btn btn-light d-flex align-items-center text-nowrap"><i
                                                                        class="ri-article-fill mr-2"></i>View as
                                                                    Client</button>
                                                ...
                                                <div class="tab-content" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="nav-summary" role="tabpanel"
                                                                    ...
                                                                    <div class="col-lg-12 bg-light p-2">
                                                                        <div class="d-flex flex-row-reverse">
                                                                            <form action="" class="mr-3"
                                                                                ...
                                                                                <button type="submit"
                                                                                    class="btn btn-warning px-3"> Publish
                                                                                    and
                                                                                    Send Email </button>
                                                                            </form>
                                                                            ...
                                                                            <form action="" class="mr-3"
                                                                                ...
                                                                                <input type="hidden" name="userid"
                                                                                    value="{{ $invoice->userid }}">
                                                                                <button type="submit"
                                                                                    class="btn btn-primary px-3">Publish
                                                                                </button>
                                                                            </form>
                                                      ...
                                                      @if ($data['status'] == 'Paid') text-success
                                                      ...
                                                      ">
                                                                        ...
                                                                        @endif
                                                                        @if ($data['status'] == 'Draft')
                                                                            <p>Payment Method: <strong>No Transactions
                                                                                    Applied</strong></p>
                                                                        @else
                                                                            <p>Payment Method:
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="col-sm-3 my-1 pl-lg-0">
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                            ...
                                                                                            value="Send Email">
                                                                                        <button type="submit"
                                                                                            class="btn btn-info btn-block m-1 px-3 text-nowrap">Send
                                                                                            Email</button>
                                                                                    </div>
                                                                                </div>
                                                                            </form>
                                                                    ...
                                                                    <div class="row justify-content-center mt-3">
                                                                        <div
                                                                            class="col-lg-12 col-sm-12 d-flex justify-content-around flex-wrap">
                                                                            <form action="" method="POST"
                                                                                ...
                                                                                <input type="submit"
                                                                                    name="AttemptCapture"
                                                                                    class="btn btn-success m-1 px-3"
                                                                                    value="Attempt Capture">
                                                                                <input type="submit" name="MarkCancelled"
                                                                                    class="btn btn-light m-1 px-3"
                                                                                    value="Mark Cancelled">
                                                                    ...
                                                                    <div class="mt-3 d-flex justify-content-center flex-wrap">
                                                                        ...
                                                                        <button onclick="resendWA({{ $invoice->id }})"
                                                                            class="btn btn-success m-1 px-3">
                                                                            Resend WA
                                                                        </button>
                                                                        ...
                                                                        {{--  <button type="button" class="btn btn-light m-1 px-3" data-toggle="modal" data-target="#sendCustomWAModal" onclick="setGroupName({{ $client->groupid }})">
																				Resend WA By GroupClients
																			</button> --}}
                                                                        ...
                                                                        <button type="button" 
                                                                            class="btn btn-success m-1 px-3" 
                                                                            data-toggle="modal" 
                                                                            data-target="#sendCustomWAModal" 
                                                                            data-groupid="{{ $invoice->groupid }}"
                                                                            data-groupname="{{ $invoice->groupname }}">
                                                                        ...
                                                                        <a href="/admin/clients/viewclients/resendWA?invoiceid={{ $invoice->id }}&preview=true"
                                                                            class="btn btn-info m-1 px-3" target="_blank">
                                                                            Preview Data </a>

                                                                        <button onclick="resendInvoiceWAAllClients()"
                                                                            class="btn btn-primary m-1 px-3">Resend WA to
                                                                            All Clients</button>
                                                                    </div>
                                                                ...
                                                                @if ($invoice->status == 'Draft')
                                                                    <div class="alert alert-warning row" role="alert">
                                                                        ...
                                                                        <div class="col-10">
                                                                            ...
                                                                            <p class="mb-0">
                                                                                {{ __('admin.invoicespublishAndSendEmail') }}
                                                                                to apply a
                                                                                payment
                                                                            </p>
                                                                        </div>
                                                                ...
                                                                @elseif ($invoice->status == 'Paid')
                                                                    <div class="alert alert-warning d-flex align-items-center"
                                                                        ...
                                                                        <div class="col-10">
                                                                            ...
                                                                            <p class="mb-0">
                                                                                As this invoice is already marked paid, any
                                                                                further payments
                                                                                applied will result in a credit to the
                                                                                client
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <form action="" method="POST">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div
                                                                                            class="input-daterange input-group inputdate">
                                                                                            <input type="text"
                                                                                                name="date"
                                                                                                class="form-control"
                                                                                                id="inputDate"
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    <label for="invoiceOptions"
                                                                                        class="col-sm-4 col-form-label">Send
                                                                                        Email</label>
                                                                                    <div
                                                                                        class="form-check text-center mt-2 col-sm-1">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="hidden" name="userid"
                                                                                value="{{ $invoice->userid }}">
                                                                            <button type="submit"
                                                                                class="btn btn-success px-3 mt-3">Add
                                                                                Payment</button>
                                                                        </div>
                                                                    </form>
                                                                @endif
                                                        ...
                                                        <form action="" method="POST">
                                                            <div class="row py-3">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="paymentMethodOptions"
                                                                            class="col-sm-2 col-form-label">Payment
                                                                            Method</label>
                                                                        <div class="col-sm-10">
                                                                            <select class="form-control"
                                                                                name="paymentmethod">
                                                                                @foreach ($gateway as $k => $v)
                                                                                    <option value="{{ $k }}"
                                                                                        @if ($invoice->paymentmethod == $k) selected @endif>
                                                                                        {{ $v }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control"
                                                                                name="invoicenum" id="invoiceOptions">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 d-flex justify-content-center">
                                                                    ...
                                                                    <input type="hidden" name="saveoptions"
                                                                        value="true">
                                                                    <input type="hidden" name="id"
                                                                        value="{{ $invoice->id }}">
                                                                    <input type="hidden" name="userid"
                                                                        value="{{ $invoice->userid }}">
                                                                    <button type="submit"
                                                                        class="btn btn-success px-3 mt-3">Save
                                                                        Changes</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row py-3 justify-content-center">
                                                            <div class="col-lg-5">
                                                                ...
                                                                <form action="" method="POST">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <input type="text" name="addcredit"
                                                                                id="addCredit" class="form-control"
                                                                                value="{{ $balance }}"
                                                                                placeholder="0.00"
                                                                                {{ $balance > 0.0 ? '' : 'disabled readonly' }}>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <input type="hidden" name="optionaddcredit"
                                                                                value="addcredit">
                                                                            <input type="hidden" name="saveoptions"
                                                                                value="true">
                                                                            <input type="hidden" name="id"
                                                            ...
                                                            <div class="col-lg-5">
                                                                <form action="" method="POST">
                                                                    ...
                                                                    <p
                                                                        class="mb-3 @if ($data['credit']->toNumeric() > 0.0) text-success @else text-danger @endif">
                                                                        {{ $data['credit']->toNumeric() > 0.0 ? $data['credit'] : '0.00' }}
                                                                        Available</p>
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-6">
                                                                            <input type="text" name="removeCredit"
                                                                                id="removeCredit" class="form-control"
                                                                                value="{{ $data['credit']->toNumeric() }}"
                                                                                {{ $data['credit']->toNumeric() > 0.0 ? '' : 'disabled readonly' }}>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <input type="hidden"
                                                                                name="Optionremovecredit"
                                                                                value="removecredit">
                                                                            <input type="hidden" name="saveoptions"
                                                                                value="true">
                                                                            <input type="hidden" name="id"
                                                                            ...
                                                                            <button class="btn btn-success px-5"
                                                                                {{ $data['credit']->toNumeric() > 0.0 ? '' : 'disabled readonly' }}>Go</button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                            ...
                                                            <div class="row py-3">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            <select name="transid" id="transRefund"
                                                                                class="form-control">
                                                                                @if (empty($conttrans))
                                                                                    <option value="">No Transactions
                                                                                        Applied To This Invoice Yet
                                                                                    </option>
                                                                                @else
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-5">
                                                                            <select name="refundtype" id="refundtype"
                                                                                class="form-control">
                                                                                <option value="sendtogateway">Refund
                                                                                    through Gateway (If
                                                                                    supported by module)</option>
                                                                                <option value="" type="">
                                                                                    Manual Refund Processed Externally
                                                                                </option>
                                                                                <option value="addascredit">Add to Client's
                                                                                    Credit Balance
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div id="TransactionID" class="form-group row"
                                                                        style="display:none;">
                                                                        <label for="refundtransid"
                                                                            class="col-sm-2 col-form-label">Transaction
                                                                            ID</label>
                                                                        <div class="col-sm-5">
                                                                            <input type="text" name="refundtransid"
                                                                                id="refundtransid" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="form-check mt-2">
                                                                                ...
                                                                                <label class="form-check-label"
                                                                                    for="defaultCheck1">
                                                                                    Undo automated actions triggered by this
                                                                                    transaction - where
                                                                                    possible.
                                                                                </label>
                                                                            </div>
                                                    ...
                                                    <div class="tab-pane fade" id="nav-notes" role="tabpanel"
                                                        ...
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="row py-3">
                                                                <div class="col-lg-12">
                                                                    <textarea name="notes" id="notesInvoice" cols="30" class="form-control" rows="10">{{ $data['notes'] }}</textarea>
                                                                </div>
                                                                <div class="col-lg-12 d-flex justify-content-center">
                                                                    <input type="hidden" name="id"
                                                                        value="{{ $invoice->id }}">
                                                                ...
                                                                <table id=""
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @foreach ($invoiceitems as $r)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <textarea class="form-control lineitem" name="item[{{ $r->id }}][description]" id="descriptionInvoice"
                                                                                        cols="3" rows="1">{{ $r->description }}</textarea>
                                                                                </td>
                                                                                <td>
                                                                                    <input type="text"
                                                                                        name="item[{{ $r->id }}][amount]"
                                                                                ...
                                                                                <td>
                                                                                    <div
                                                                                        class="form-check text-center mt-2">
                                                                                        <input class="form-check-input"
                                                                                ...
                                                                                <td class="text-center align-middle">
                                                                                    <button type="button"
                                                                                        ...
                                                                                        onclick="deleteInvoiceItemById({{ $r->id }})"><i
                                                                        ...
                                                                        <tr>
                                                                            <td></td>
                                                                            <td>
                                                                                <textarea class="form-control" name="adddescription" id="descriptionInvoice" cols="3" rows="1"></textarea>
                                                                            </td>
                                                                            <td>
                                                                    ...
                                                                    <tfoot>
                                                                                ...
                                                                                <div class="row align-items-center">
                                                                                    <div class="col-lg-6">
                                                                                        <select type="select"
                                                                                            ...
                                                                                            id="mass-input">
                                                                                            <option value="none">With
                                                                                                Selected</option>
                                                                                            <option value="split">Split To
                                                                                                New Invoice</option>
                                                                        ...
                                                                        <tr class="bg-primary text-white">
                                                                            ...
                                                                            <th class="text-center">{{ $data['total'] }}
                                                                            </th>
                                                                            <th></th>
                                                                            <th></th>
                                                                        </tr>
                                                                ...
                                                                <tbody>
                                                                    @foreach ($transactions as $transaction)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @php
                                                                                    // Extract the transaction ID from the HTML string
                                                                                    preg_match("/doDeleteTransaction\('(\d+)'\)/", $transaction[5], $matches);
                                                                                ...
                                                                                @if($transactionId)
                                                                                            ...
                                                                                            <button type="button"
                                                                                        class="btn btn-link text-danger"
                                                                                        onclick="doDeleteTransaction({{ $transactionId }})"><i
                                                                                            class="fas fa-trash"></i></button>
                                                                                @endif
                                                                            </td>
                                                ...
                                                <!--WA POPUP-->
                                                <div class="modal fade" id="sendCustomWAModal" tabindex="-1"
                                                    role="dialog" aria-labelledby="sendCustomWAModalLabel"
                                                    aria-hidden="true">
                                                    {{-- <div class="modal-dialog" role="document"> --}}
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="sendCustomWAModalLabel">Send
                                                                    WA Message To All Active Clients</h5>
                                                                <button type="button" class="close"
                                                                    data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <form id="customWAForm"
                                                                action="/admin/clients/viewclients/sendCustomWA"
                                                                method="GET">
                                                ...
                                                <input type="number" class="form-control" id="delaySeconds" name="delay" value="15" min="1" required> --}}
                                                                        <label for="delaySeconds">Delay between messages
                                                                            (seconds):</label>
                                                                        <select class="form-control" id="delaySeconds"
                                                                            name="delay" required>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary"
                                                                        onclick="resendWAByGroup(this.form)">Send
                                                                        Message</button>
                                                                </div>
                                                            </form>
                                                        </div>
...
@section('scripts')
    ...
    <script>
        $('#sendCustomWAModal').on('show.bs.modal', function(event) {
            ...
            modal.find('#customWAForm').data('groupname', groupName);
        });

        function resendWAByGroup(form) {
            const groupId = $(form).data('groupid') || 4;
            const groupName = $(form).data('groupname') || 'Jogja';
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.open(
                        `/admin/clients/viewclients/resendWABulk?show_loading=1&groupid=${groupId}&message=${encodeURIComponent(customMessage)}&delay=${delay}`,
                        '_blank');
                }
            });
        }
        ...
        function resendWA(invoiceId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.open(`/admin/clients/viewclients/resendWA?show_loading=1&invoiceid=${invoiceId}`,
                        '_blank');
                }
            });
        }
    ...
    <script>
        function doDeleteTransaction(id) {
            Swal.fire({
                title: 'Are you sure?',
                text: "{{ Lang::get('admin.invoicesdeletetransaction') }}",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
