    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="alert alert-info-custom">
                ...
                <ul>
                    <li>dnsii1.qwords.net</li>
                    <li>dnsii2.qwords.net</li>
                </ul>
                <p>Jika membutuhkan bantuan silakan hubungi kami melalui support ticket <a href="https://s.id/16Akz"
                        target="_blank">https://s.id/16Akz</a></p>
            </div>
            ...
            <div class="alert alert-danger-custom">
                <p>Module could not find any existing DNS zone for this domain name. Do you want to create an empty DNS Zone
                    now? (this process takes a long time ± 5 minutes)</p>
            </div>

            <div class="action-buttons">
                <a href="{{ route('pages.domain.mydomains.index') }}" class="btn btn-outline-warning btn-responsive">No, Go
                    back.</a>
                <a href="#" class="btn btn-danger btn-responsive btn-yes">Yes, Create.</a>
            </div>
        </div>
    </div>
@endsection
