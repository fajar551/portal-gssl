...
<body>
    <div class="container" style="position:relative;">
        ...
        <table border="0" width="100%">
            <tr>
                <td width="50%" style="border-top:0;">
                    <p><img src="{{ $logo }}" title="{{ $CompanyName }}"
                            style="height: 120px; margin-top: -81px;"></p>
                </td>
                <td width="50%" style="border-top:0;">
        ...
        <div class="diskripsi" style="font-size: 18px; margin-bottom:40px;">
            <p>Invoice yang melebihi masa due date akan diperbaharui isinya sesuai ketentuan yang berlakuuuuuuuuuuuuuu</p>
            <p>
