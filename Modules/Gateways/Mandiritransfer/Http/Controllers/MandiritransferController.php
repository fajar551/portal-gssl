...
namespace Modules\Gateways\Mandiritransfer\Http\Controllers;

use Illuminate\Contracts\Support\Renderable;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;

class MandiritransferController extends Controller
{
    /**
    ...
    {
        $configarray = array(
            "FriendlyName" => array("Type" => "System", "Value" => "Mandiri Transfer"),
            "instructions" => array("FriendlyName" => "Mandiri Transfer Instructions", "Type" => "textarea", "Rows" => "5", "Default" => "Bank Name:\nPayee Name:\nSort Code:\nAccount Number:",
