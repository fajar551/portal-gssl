<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        <div class="flex items-center flex-no-shrink">
            <a href="{{ url('/docs/1.0/get-started/overview') }}" class="flex items-center flex-no-shrink text-black mx-4">
                <div>
                    <img src="{{ url('themes/admin/assets/images/WHMCEPS.png') }}" alt="logo" width="100">
                    <p class="inline-block font-semibold mx-3 text-grey-dark">
                        Developer Guide
                    </p>
                </div>
            </a>
